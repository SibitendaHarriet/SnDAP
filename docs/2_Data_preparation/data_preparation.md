...
`./docs/2_Data_preparation/language_detection.png`
...
```
   textid                       Date  Views sourcetype  Tweet Id  RetweetCount  Likes  Replies                                               Text  language   Username                                              Texty               Textf  alltext  textid Text_emt                                      Text_emj Text_langue  Text_translate  Text_cleaned            Text_token  Text_stop                            Text_stem             Text_lemma
0      1  2019-12-19 15:30:09+00:00      0    twitter      12345         10      5       2       climate smart water governance shared ecosyste   en      user1    climate smart water governance shared ecosystem   NaN        ['climate', 'smart', 'water', 'governance', 'shared', 'ecosystem']   climate smart water governance shared ecosystem    ['climat', 'smart', 'water', 'govern', 'share', 'ecosystem']      ['climat', 'smart', 'water', 'govern', 'share', 'ecosystem']
1      2  2019-12-05 15:58:40+00:00     54    twitter      12346         15      8       1  reasadness says universal health coverage soci...   en      user2    reasadness says universal health coverage soci...  NaN        ['read', 'says', 'universal', 'health', 'cover', 'soci']  reasadness says universal health coverage    ['read', 'say', 'univers', 'health', 'cover', 'soci']         ['read', 'say', 'univers', 'health', 'cover', 'soci']
```
